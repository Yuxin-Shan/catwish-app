...
```bash
git add .
git commit -m "feat(milestone-3): Task 3.9 - Create ScreenHeader component"
git commit -m "refactor(milestone-3): Task 3.10 - Replace navigation bars with ScreenHeader"
git commit -m "test(milestone-3): Task 3.11 - Integration and regression tests"
```
